...
import { FILTER, REVERB, DELAY, TREMOLO, INTENSITY } from '../config.js';
...
export function mapSignalsToSnapshot(signals, enabled = { filter: true, reverb: true, delay: true, tremolo: true }) {
